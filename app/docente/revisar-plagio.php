...
<body>
    ...
    <div class="content" id="content">
        <div class="container mt-3">
            <h1 class="text-center mb-4 fw-bold">Revisar Plagio</h1>
                            ...
                            <?php while ($row = $result_temas->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                            <a class="text-decoration-none d-inline-flex align-items-center" href="../uploads/documento-plagio/<?php echo basename($row['observaciones']); ?>" download>
                                                Descargar
                                            </a>
                                        <?php else: ?>
                                ...
                                <div class="modal fade" id="modalSubirObservaciones<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="modalSubirObservacionesLabel<?php echo $row['id']; ?>" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="subir-doc-plagio.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal fade" id="modalEliminar<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="modalEliminarLabel<?php echo $row['id']; ?>" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="subir-doc-plagio.php" method="POST">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p>¿Está seguro de que desea eliminar el documento de plagio de este tema?</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
