...
<body>
  ...
  <div class="content" id="content">
    <div class="container mt-3">
      <h1 class="text-center mb-4 fw-bold">Certificación </h1>
              ...
              <?php while ($row = $result_temas->fetch_assoc()): ?>
                <tr>
                  ...
                  <td>
                    ...
                    if (!empty($row['certificados'])):
                    ?>
                      <a class="text-decoration-none d-inline-flex align-items-center" href="../uploads/certificados/<?php echo basename($row['certificados']); ?>" download>
                        Descargar
                      </a>
                    <?php else: ?>
                  ...
                  <td class="text-center">
                    <div class="d-flex justify-content-center gap-2">
                      ...
                      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalSubirCertificados<?php echo $row['id']; ?>">
                ...
                <!-- Modal Subir -->
                <div class="modal fade" id="modalSubirCertificados<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="modalSubirObservacionesLabel<?php echo $row['id']; ?>" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form action="subir-doc-certificado.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal fade" id="modalEliminar<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="modalEliminarLabel<?php echo $row['id']; ?>" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <form action="subir-doc-certificado.php" method="POST">
                        <div class="modal-header">
                          <h5 class="modal-title" id="modalEliminarLabel<?php echo $row['id']; ?>">Eliminar Certificado</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                          <input type="hidden" name="tesis_id" value="<?php echo $row['id']; ?>">
                          ...
                          <p>¿Está seguro de que desea eliminar el certificado de este tema?</p>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
