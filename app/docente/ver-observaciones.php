        ...
        <div class="container-fluid py-3">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <h1 class="display-4 mb-3 fw-bold">Revisa las Observaciones Realizadas</h1>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card card-principal h-100 shadow">
                                <div class="card-body text-center">
                                    ...
                                    <a href="observaciones-anteproyecto.php" class="btn">Acceder</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="card card-principal h-100 shadow">
                                <div class="card-body text-center">
                                    ...
                                    <a href="observaciones-tesis.php" class="btn">Acceder</a>
                                </div>
                            </div>
                        </div>
                    </div>
