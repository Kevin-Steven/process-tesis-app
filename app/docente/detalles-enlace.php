...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT t.tema, t.enlace_plagio, t.correcciones_tesis, t.usuario_id, t.pareja_id, 
...
<body>
    ...
    <div class="sidebar z-2" id="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <div class="collapse show" id="submenuPlagio">
                <ul class="list-unstyled ps-4">
                    <li>
                        <a class="nav-link active<?php echo basename($_SERVER['PHP_SELF']) == 'revisar-plagio.php' ? 'active bg-secondary' : ''; ?>" href="revisar-plagio.php">
                            <i class="bx bx-file"></i> Revisar
                        </a>
                    </li>
                </ul>
    ...
    <div class="content" id="content">
        <div class="container mt-2">
            <h1 class="mb-4 text-center fw-bold">Detalle del enlace</h1>
            <div class="card shadow-lg">
                <div class="card-body">
                    <h5 class="card-title text-primary text-center fw-bold mb-4">Información del enlace</h5>
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <th><i class="bx bx-book"></i> Link informe de plagio</th>
                                    <td><?php
                                        if (!empty($tema['enlace_plagio'])) {
                                            echo "<a href='" . $tema['enlace_plagio'] . "' target='_blank'>" . $tema['enlace_plagio'] . "</a>";
                                        } else {
    ...
    <div class="modal fade" id="modalConfirmarAprobar" tabindex="-1" aria-labelledby="modalConfirmarAprobarLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="aprobar_enlace.php" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalConfirmarAprobarLabel">Confirmar Aprobación</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                    </div>
                    <div class="modal-body">
                        ¿Estás seguro de que deseas aprobar el enlace de esta tesis?
                    </div>
    ...
    <div class="modal fade" id="modalConfirmarRechazar" tabindex="-1" aria-labelledby="modalConfirmarRechazarLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="rechazar_enlace.php" method="post">
                    <div class="modal-header">
