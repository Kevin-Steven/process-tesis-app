...
<body>
    ...
    <div class="content" id="content">
        <div class="container mt-2">
            <h1 class="mb-3 text-center fw-bold">Informes Revisores Tesis</h1>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT it.id, it.informe_tesis, it.fecha_subida, u.nombres, u.apellidos
                            FROM informes_tesis it
                        ...
                        if ($result->num_rows > 0):
                            while ($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../uploads/informes-tesis/<?php echo $row['informe_tesis']; ?>" download>
                                            <?php echo $row['informe_tesis']; ?>
                                        </a>
                                    </td>
                                </tr>
                            <?php endwhile;
